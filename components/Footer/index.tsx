      ...
      <div className="container mx-auto lg:grid grid-cols-12 grid-rows-2 gap-10 text-white">
        ...
        <div className="lg:col-span-7 row-span-2 grid grid-cols-2 lg:grid-cols-4 gap-6 mb-6 lg:mb-0">
          ...
          <div>
            ...
            <ul className="grid gap-2">
              <li><a href="https://vk.com/choosetoteachrussia" target="_blank" rel="noopener noreferrer">vk.com</a></li>
              <li><a href="https://www.youtube.com/channel/UCsEEzd2ULv7L_y3C1B1LewQ" target="_blank" rel="noopener noreferrer">youtube.com</a></li>
              <li><a href="https://t.me/choosetoteach_official" target="_blank" rel="noopener noreferrer">telegram</a></li>
              <li><a href="https://dzen.ru/choosetoteach" target="_blank" rel="noopener noreferrer">Дзен</a></li>
            </ul>
          </div>
        </div>
