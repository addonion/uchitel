...
import type { MenuLink } from '../shared/api'

export default function Dropdown({ name, buttonClasses, list }: { name: string, buttonClasses: string, list: MenuLink[] }) {
  return (
